 ...
 */
final class Version20240620134409 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_8157AA0FD840794C ON profile');
        $this->addSql('ALTER TABLE profile DROP usser_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile ADD usser_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE profile ADD CONSTRAINT FK_8157AA0FD840794C FOREIGN KEY (usser_id) REFERENCES user (id)');
        $this->addSql('CREATE INDEX IDX_8157AA0FD840794C ON profile (usser_id)');
